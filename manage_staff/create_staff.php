                           ...
                           <div class="card-body">
                             <input type="text" class="form-control" id="staff_id" name="staff_id" hidden>
                               <div class="form-group row">
                                   ...
                                   <div class="col-sm-9">
                                       <input type="text" class="form-control" id="staff_fname" name="staff_fname" pattern="[A-Za-zก-๙]{1,}" required>
                               ...
                               <div class="form-group row">
                                   ...
                                   <div class="col-sm-9">
                                       <input type="text" class="form-control" id="staff_lname" name="staff_lname" pattern="[A-Za-zก-๙]{1,}" required>
                                       <div class="invalid-feedback">
                               ...
                               <div class="form-group row">
                                   ...
                                   <div class="col-sm-9">
                                       <input type="email" class="form-control" id="staff_email" name="staff_email" pattern="[a-zA-Z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required>
                                       <div class="invalid-feedback">
